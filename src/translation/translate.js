...
// Access Attr and Node from JSDOM window object
var Attr = dom.window.Attr;
var Node = dom.window.Node;

// Shimming innerText property for JSDOM attributes
Object.defineProperty(Attr.prototype, 'innerText', {
    get: function() { return this.textContent; },
    set: function(value) { this.textContent = value; },
    configurable: true,
});

// Shimming innerText property for JSDOM nodes
